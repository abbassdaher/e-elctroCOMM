  ...
  return (
    <div>
      ...
      >
        ...
        {/* <span className="bg-gray-200 rounded-full -ml-3 -mt-3 px-0.5 py-0.5 text-xs font-semibold text-red-600">
          {cartItems.length}
        </span> */}
      </div>
      ...
      <ul
        ...
        className=" hidden absolute z-10 min-w-[200px] max-h-50  overflow-auto rounded-lg border border-slate-200 bg-white p-1.5 shadow-lg shadow-sm focus:outline-none"
      >
        {cartItems.length ? (
            ...
            return (
              <Stack>
                ...
                >
                  <li
                    role="menuitem"
                    className=" cursor-pointer text-slate-800 flex   text-sm items-center rounded-md p-1.5 transition-all hover:bg-slate-100 focus:bg-slate-100 active:bg-slate-100"
                  >
                    <img
                      alt="tania andrew"
                      src={item.images[0]}
